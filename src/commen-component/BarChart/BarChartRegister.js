...
//   useLayoutEffect(() => {
//     // Create chart root
//     const root = am5.Root.new("chartdivRegister");
...
//   return <div id="chartdivRegister" style={{ width: "100%", height: "400px" }}></div>;
// };
...
const BarChartRegister = () => {
    useLayoutEffect(() => {
        ...
        series.columns.template.setAll({
            fillGradient: am5.LinearGradient.new(root, {
                stops: [
                    { color: am5.color(0x75d9e6) },
                    { color: am5.color(0xc843ff) },
                ],
    ...
    return <div id="chartdivRegister" style={{ width: "400px", height: "500px", position: "relative" }}>
        <div style={{ position: "absolute", width: "100px", height: "20px", backgroundColor: "white", bottom: 50, zIndex: 100 }}></div>
    </div>;
};

export default BarChartRegister;
